...
export default function MultiStep(props) {
    ...
    show && (
      <div className="step-footer">
        <button
          ...
          onClick={previous} className="btn-first white-btn"
        >
          Previous
        </button>
        ...
        <button
          ...
          onClick={next} className="btn-first white-btn"
        >
          Next
        </button>
      </div>
  ...
  return (
    <div onKeyDown={handleKeyDown} id="add-restaurent-tab" className="step-app">
      <div className="row">
        <div className="col-xl-4 col-lg-5 mb-md-40">
          <Ol className="step-steps steps-1">{renderSteps()}</Ol>
          <Ol className="step-steps steps-2">{renderStepstwo()}</Ol>
