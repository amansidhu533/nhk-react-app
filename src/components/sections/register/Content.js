                                        ...
                                        <form>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-12">
                                                    ...
                                                    </div> <span className="text-light-black fs-12 terms">By creating your Quickmunch account, you agree to the <Link to="#"> Terms of Use </Link> and <Link to="#"> Privacy Policy.</Link></span>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
