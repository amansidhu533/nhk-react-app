...
class Freshdeals extends Component {
    render() {
        const settings = {
            slidesPerView: 1,
            spaceBetween: 15,
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="section-header-left">
                                <h3 className="text-light-black header-title">Fresh deals nearby</h3>
                                <p className="text-light-black">Find new Restaurants with deals near you</p>
                            </div>
                        </div>
                        <div className="col-12">
                            <Swiper className="fresh-deals-slider swiper-container" {...settings} navigation>
                                {product.map((item, i) => (
                                    <SwiperSlide key={i}>
