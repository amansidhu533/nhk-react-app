...
import img1 from '../../../assets/img/restaurants/604x240/shop-9.jpg';
import img2 from '../../../assets/img/restaurants/604x240/shop-10.jpg';
import img3 from '../../../assets/img/restaurants/604x240/shop-1.jpg';
import img4 from '../../../assets/img/restaurants/604x240/shop-3.jpg';
...
class Chefspecial extends Component {
    render() {
        const settings = {
            slidesPerView: 1,
            spaceBetween: 15,
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="section-header-left">
                                <h6 className="text-light-green sub-title">Fresh Ingredients</h6>
                                <h3 className="text-light-black header-title title">Chef Special</h3>
                            </div>
                        </div>
                        <div className="col-12">
