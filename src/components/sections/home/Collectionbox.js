...
// Extra
import largeimg1 from '../../../assets/img/restaurants/255x587/Banner-12.jpg';
import largeimg2 from '../../../assets/img/restaurants/255x587/Banner-1.jpg';
import largeimg3 from '../../../assets/img/restaurants/255x587/Banner-2.jpg';
import largeimg4 from '../../../assets/img/restaurants/255x587/Banner-3.jpg';
import unlimited1 from '../../../assets/img/restaurants/1110x100/vbanner-2.jpg';
import unlimited2 from '../../../assets/img/restaurants/1110x100/vbanner-3.jpg';
import unlimited3 from '../../../assets/img/restaurants/1110x100/vbanner-1.jpg';
...
import tpcl3 from '../../../assets/img/restaurants/540x300/collection-3.jpg';
import tpcl4 from '../../../assets/img/restaurants/540x300/collection-4.jpg';
// Top collection
const topcollection = [
            ...
            <section className="ex-collection section-padding">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="banner-adv2 mb-xl-20">
                                ...
                                <span className="text">Unlimited Free Delivery with.
                                    <img src={logo} alt="" />
                                    <Link to="/restaurant" className="btn-second btn-submit">Try 30 Days FREE</Link>
                                </span>
                                ...
                                {product.map((item, i) => (
                                    <div key={i} className="col-lg-4 col-md-6 col-sm-6">
                                        <div className="product-box mb-xl-20">
                                            <div className="product-img">
                                                <Link to="/restaurant">
                                                    <img src={item.img} className="img-fluid full-width" alt="product" />
                                                </Link>
                                                <div className="overlay">
                                                    <div className="product-tags padding-10">
                                                        <span className="circle-tag">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="banner-adv2 mb-xl-20">
                                <img src={unlimited2} className="img-fluid full-width" alt="" /> <span className="text">Unlimited Free Delivery with.
                                <img src={logo} alt="" />
                                    <Link to="/restaurant" className="btn-second btn-submit">Try 30 Days FREE</Link></span>
                                <span className="close-banner" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-4">
                            <div className="large-product-box mb-xl-20 p-relative">
                                <img src={largeimg3} className="img-fluid full-width" alt="" />
                                <div className="category-type overlay padding-15">
                                    <button className="category-btn">Most popular near you</button> <Link to="/restaurant" className="btn-first white-btn text-light-black fw-600 full-width">See all</Link>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="banner-adv2 mb-xl-20">
                                <img src={unlimited3} className="img-fluid full-width" alt="" /> <span className="text">Unlimited Free Delivery with.
                                <img src={logo} alt="" />
                                    <Link to="/restaurant" className="btn-second btn-submit">Try 30 Days FREE</Link></span>
                                <span className="close-banner" />
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-4">
                            <div className="large-product-box mb-xl-20 p-relative">
                                <img src={largeimg4} className="img-fluid full-width" alt="" />
                                <div className="category-type overlay padding-15">
                                    <button className="category-btn">Most popular near you</button> <Link to="/restaurant" className="btn-first white-btn text-light-black fw-600 full-width">See all</Link>
                                </div>
                            </div>
