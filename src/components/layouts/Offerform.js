            ...
            <div className="card sidebar-card">
                <div className="card-header no-padding">
                    <div className="offer-content">
                        ...
                        <p className="text-custom-white">As an added treat, enjoy <strong>free delivery</strong> from
                    ...
                    <form>
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="text-center"> <span className="text-light-black fs-12">*Valid on first order only, for one-time use, subject to Quickmunch’s verification. Additional terms may apply. By signing up, you agree to receive marketing and
